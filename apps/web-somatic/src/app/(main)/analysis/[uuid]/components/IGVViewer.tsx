...
export function IGVViewer({
  ...
  // Merge deprecated bamUrl into tracks
  ...
  React.useEffect(() => {
    ...
    async function initIGV() {
      try {
        ...
        const options: Record<string, unknown> = { locus };
  ...
  }, [isOpen, locus, genome, reference, allTracks]);
