...
function CreateBaselineModal({
  ...
  const handleSubmit = () => {
    ...
    setFormData({ bedFile: '肺癌168基因_Panel.bed', description: '', sampleIdsText: '' });
    onClose();
  };
        ...
        <div className="p-6 space-y-4 overflow-y-auto max-h-[calc(90vh-140px)]">
          ...
          <div className="p-3 bg-blue-50 rounded-lg">
            <p className="text-xs text-blue-600">
              提示：基线构建会同时生成 CNV 基线和 MSI 基线，创建后需点击"启动"开始构建。
      ...
      <div className="p-6">
        ...
        <div className="p-4 bg-canvas-subtle rounded-lg border border-border mb-4">
          <p className="text-sm text-fg-muted">
            基线用于 CNV（拷贝数变异）和 MSI（微卫星不稳定性）检测。启动基线构建时会同时生成 CNV 基线和 MSI 基线。
